 ...
 * 
 * KlijentskaNit je klasa koja nasleđuje Thread i predstavlja serversku nit koja
 * se pokreće za svakog klijenta koji se poveže sa serverom. Svaka instanca ove
 * klase ima svoj socket preko kojeg komunicira sa klijentom.
 * 
...
public class KlijentskaNit extends Thread {
	...
	/**
	 * Promenljiva koja označava da li je nit završena. Ukoliko je vrednost
	 * postavljena na true, nit će se zaustaviti.
	 */
